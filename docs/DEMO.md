...
1. Open the public demo. It selects candidate `790c7762-e9bf-4ab7-abdb-31854091c15d` with exact baseline `b2998668-7680-4f95-9811-76b7e6132e6a`; **Start 90-second tour** restores that route at any time.
...
7. Choose **Second workflow proof** to open the model-backed Fieldnotes pair and show that the same bounded Nemotron contract and runner load a different target, build pair and check catalog without scenario-specific runner code.
