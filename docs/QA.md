...
- Linux CI's narrower Chrome geometry exposed undersized report-action links after the new mobile regression ran. The links now have 30-pixel minimum height and padding; the same test keeps its 390-pixel viewport through the expanded comparison accessibility scan.
