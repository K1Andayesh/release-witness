...
- Bound the exact release and immutable Git commit into the benchmark receipt, exposed both source links on the receipt, and made the landing-page source shortcut resolve to the deployed commit rather than moving `main`.
