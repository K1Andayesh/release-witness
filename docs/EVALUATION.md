...
The four recorded benchmark runs were re-attested from intact v2 reports to v3 full-record receipts on 17 September 2026. Their checks, screenshots, model responses, timings and counts did not change; only the receipt schema and digests changed. No fresh provider call was made for the migration.
